...
<head>
    ...
    <title>Resumen General - FNG</title>
...
<body>
    ...
    <main class="main">
        ...
        <section class="main__section" id="section_registro">
            <div class="contenido-section max-container--160-95">
                ...
                <form method="get" class="formulario" id="formulario"> 
                    ...
                    <div class="estatus">
                        ...
                        <select name="estatus" id="estatus">
                            ...
                            <option value="FIN">Terminada</option>
                            <option value="TER">Finalizada</option>
                        </select>
                    </div>
    ...
    <script src="../js/resumenGeneral.js"></script>
