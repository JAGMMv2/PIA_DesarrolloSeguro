    ...
    function showData(datos){
        ...
        // CICLO INICAL QUE MUESTRA LOS PRIMEROS 25 REGISTROS
            for (let i = 0; i <= 24; i++) {
                ...
                // CICLO QUE PONE Y LEE LOS VALORES DE 0 - 16 PARA LA PRIMERA TABLA
...
// * CREAR TABLA DE REGISTROS
    function createTable(){
        ...
        // * CREO EL CONTENDOR DE LOS REGISTROS DONDE IRA TODA LA INFORMACION DE LA GRANDE
            ...
            divContendorRegistros.classList.add("tablaAntiguedades");
            tabla2.appendChild(divContendorRegistros);

            const divContendorPadre = document.getElementById("tablaContendorRegistros");
        
        // * CREO LOS TITULOS
            const nombresTitulos = ['# de Corte', 'Base', 'Bitacora', '# Factura', 'Fecha', 'Folio Fiscal', 'Importe Pago', 'Total Factura', 'Notas Cargo', 'Notas Credito', 'Fecha Inicio Corte', 'Fecha Fin Corte', 'Calculo', 'Diferencia', 'Fecha Vencido', 'Vencimiento', 'Clasificacion']
        ...
        // * CREO QUE LAS SEPARACION
            ...
            separacion.classList.add("tablaAntiguedades__separacion");
